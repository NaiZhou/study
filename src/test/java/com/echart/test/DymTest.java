...
//		List<Family> residents = new ArrayList<Family>();
//		List<Rels> rs = new ArrayList<Rels>();
//		
//		Family resident =  new Family();
//
//		Iterable<Family> It = personsRepository.findResident(); 
//		Iterator<Family> iter = It.iterator();
//		HAS_FAMILY helpby = new HAS_FAMILY();
//		Set<HAS_FAMILY> relations = new HashSet<HAS_FAMILY>();
//		while(iter.hasNext()) {
//			resident = iter.next();
//			System.out.println(resident.getName());
//			
//			relations = resident.getHelped_by();
//			for(HAS_FAMILY str : relations) {
