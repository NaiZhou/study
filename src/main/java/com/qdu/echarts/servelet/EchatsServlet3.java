 ...
 */
public class EchatsServlet3 extends HttpServlet {
...
//	        response.getWriter().write(result);  
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		name2 = request.getParameter("startnode");
		ApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath*:/spring/dal-neo4j-context.xml");
		getSearchRel a = (getSearchRel) applicationContext.getBean("getSearchRel");
		String result = new String();
		result =a.getdata(name, name2);
